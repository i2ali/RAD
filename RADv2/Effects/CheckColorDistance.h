...
class CheckColorDistance : public ID2D1EffectImpl, public ID2D1ComputeTransform, public ID2D1AnalysisTransform
{
// Constructor
public:
    CheckColorDistance(void);


// Destructor
public:
    virtual ~CheckColorDistance(void);
