...
//
//  Description:
//      Defines an effect that takes a color distance image and creates an RGB
//      image from it.  In other words, it creates a diff image.
//
//------------------------------------------------------------------------------
...
class ColorDistanceToRgb : public ID2D1EffectImpl, public ID2D1DrawTransform
{
// Constructor
public:
    ColorDistanceToRgb(void);


// Destructor
public:
    virtual ~ColorDistanceToRgb(void);
