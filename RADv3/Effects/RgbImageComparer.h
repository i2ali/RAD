...
class RgbImageComparer : public ID2D1EffectImpl, public ID2D1ComputeTransform, public ID2D1AnalysisTransform
{
// Constructor
public:
    RgbImageComparer(void);


// Destructor
public:
    virtual ~RgbImageComparer(void);
